...
const ortalama1 = () => {
  for (let i = 0; i < numbers.length; i++) toplam += numbers[i];
  return toplam;
};
...
function returnWord(number) {
  ...
  if (numString.length === 1) {
    word = ones[parseInt(numString)];
  } else if (numString.length === 2) {
    word =
      tens[parseInt(numString[0])] +
      (numString[1] === "0" ? "" : " " + ones[parseInt(numString[1])]);
    ...
    word =
      ...
      (numString[1] === "0"
        ...
        : " " +
          ...
          (numString[2] === "0" ? "" : " " + ones[parseInt(numString[2])]));
  } else {
     word = "Bu program sadece 0-999 arasındaki sayıları desteklemektedir.";
...
console.log(returnWord(30));
console.log(returnWord(700));
console.log(returnWord(514));
console.log(returnWord(7858));
