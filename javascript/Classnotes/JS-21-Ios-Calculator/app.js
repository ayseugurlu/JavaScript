...
num.forEach((number) => {
  number.onclick = () => {
    ...
    //yukaridaki islem fonk da yapilmasi icin bu sekilde kullanildi 
...
const ekranaHazirlik = (num) => {
    ...
    // kullanici uzun bir sayi girerse
...
const hesapla=()=>{
    switch(islem){
        case "+" : sonuc = Number(ustekranText) + Number(altekranText);
        break;
        case "-" : spnuc = ustekranText - altekranText;
        break;
        case "x" : sonuc = ustekranText * altekranText;
        break;
        case "÷" : sonuc = ustekranText / altekranText;
        break;
        default:
            break;
    }
