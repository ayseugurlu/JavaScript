...
function pieceUrun(){
    ...
    //! ürünToplam in ekranda güncellenmesi
    ...
    //! ürünToplam in ekranda güncellenmesi
    minus.closest(".card-body").querySelector(".product-total").textContent = minus.closest(".card-body").querySelector(".indirim-price").textContent * adet.textContent
        ...
        sepettekiler.map((ürün) => {
            ...
            if(ürün.name == minus.closest(".card-body").querySelector("h5").textContent){
        ...
        //! eger adet 1 iken tekrar eksi ye basilirsa ürün silinsin
...
function calculateTotal() {
  ...
  //?Reduce tam olarak Array istiyor, nodelist yeterli değil
    ...
    const ürünToplam =Array.from( document.querySelectorAll(".product-total")).reduce((acc,item) => acc+ Number(item.textContent),0)
...
document.querySelector(".toplam").textContent = shipping + ürünToplam + ürünToplam*tax
