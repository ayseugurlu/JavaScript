...
const car2 = new Object({ name: "Mercedes", engine: 2.0, model: 2008 });
...
console.log(person.children.first);
...
console.log(Object.values(mensch)); //object in value larini bir diziye atar
...
//*ornek2 yaslari 1 er arttir ve sonucu yeni bir diziye aktar
...
console.log(people)
  ...
  const ortlama=people.reduce((toplam,eleman)=>toplam+eleman.age,0)/people.length
...
const menschen = {
  ...
  //! nested oject lerde FOR - IN kullanılabilir, index sonuçta. Ama for of kullanılamaz , dizilerde verileri almak için itere eden for of object te çalışmaz
...
//   for(let item of menschen){

//     console.log(item) //TypeError: menschen is not iterable
//   }
  ...
  console.log(Object.values(menschen))
